...
class HotArticleListRepositoryTest {
    ...
    void addTest() throws InterruptedException {
        // given
        LocalDateTime time = LocalDateTime.of(2025, 10, 7, 2, 44);
        long limit = 3;
        ...
        // then
        List<Long> articleIds = hotArticleListRepository.readAll("20251007");
        ...
        assertThat(hotArticleListRepository.readAll("20251007")).isEmpty();
    }
}